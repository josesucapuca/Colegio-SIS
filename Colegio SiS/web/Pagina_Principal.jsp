...
%>
<%@page import="pe.edu.sis.application.factory.SessionSystem"%>
<%@page import="pe.edu.sis.application.factory.FactoryConnectionDB"%>
<%@page import="pe.edu.sis.application.model.V_Privilegio"%>
<jsp:useBean id="listarURL" scope="session" class="java.util.ArrayList"/>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>Material Admin - Charts</title>
                    ...
                    <ul class="header-nav header-nav-profile">
                        <li class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle ink-reaction" data-toggle="dropdown">
                                <img src="assets/img/avatar1.jpg?1403934956" alt="<%--out.println((String) sesion.getAttribute("USER"));--%>" />
                                <span class="profile-info">
                                    <%--out.println((String) sesion.getAttribute("NOMBRE_AP").toString().trim()); --%>
                                    <small><%=(String)sesion.getAttribute("USER")%></small>
                                </span>
                            </a>
                            <ul class="dropdown-menu animation-dock">
                                ...
                                <li><a href="Logueo.jsp"><i class="fa fa-fw fa-power-off text-danger"></i> Logout</a></li>
                            </ul><!--end .dropdown-menu -->
                        </li><!--end .dropdown -->
        ...
        <div id="base">
            ...
            <div id="content">
                ...
                <div class="row ">
                    ...
                    <iframe id="myframe" name="myframe"  style="display:"  class="iframe_principal" scrolling="si"  width="100%" height="800" frameborder="0" src=""></iframe>
                </div>
            ...
            <div id="menubar" class="menubar-inverse ">
                <div class="menubar-fixed-panel">
                    ...
                    <div class="expanded">
                        <a href="../vista/Rol/">
                            <span class="text-lg text-bold text-primary "><%--out.println((String) sesion.getAttribute("USER"));--%></span>
                        </a>
                    </div>
                </div>
                <div class="menubar-scroll-panel">
                    ...
                    <ul id="main-menu" class="gui-controls">
                        ...
                        <li>
                            ...
                            <a href="<%=dp.getDi_url()%>"  target="myframe" title="<%=dp.getNo_link()%>" data-value="<%=dp.getIc_link().trim()%>">
                                <div class="gui-icon"><i class="md md-home"></i></div>
                                <span class="title"><%=dp.getNo_link()%></span>
                            </a>
                        </li>
