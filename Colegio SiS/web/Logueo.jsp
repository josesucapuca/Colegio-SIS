    ...
    <body class="menubar-hoverable header-fixed" >
        ...
        <section class="section-account">
            <div class="img-backdrop">
                <img src="img/img_pres.jpg" style="max-width: 1318px;max-height: 150px;">
            </div>
            ...
            <div class="card contain-sm style-transparent">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <br/>
                            <span class="text-lg text-bold text-primary">San Ignacio School</span>
                            <br/><br/>
                            <form id="login-form" class="form floating-label" >
