...
import pe.edu.sis.application.model.Usuario;
...
public class UsuarioDAO implements InterfaceUsuarioDAO{
    ...
    public List<Usuario> USER_LOGIN(String Usuario, String PWD) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                us.setId_usuario(rs.getString("id_usuario"));
                us.setId_rol(rs.getString("id_rol"));
                us.setId_empleado(rs.getString("id_persona"));
                us.setNo_usuario(rs.getString("no_usuario"));
                us.setPw_usuario(rs.getString("pwr_usuario"));
                list.add(us);
            }
        } catch (SQLException ex) {
            throw new RuntimeException(ex.getMessage());
    ...
    public List<V_Usuario> Val_Usuario(String Usuario, String PWD) {
        this.conn = FactoryConnectionDB.open(FactoryConnectionDB.ORACLE);
        String sql = "select * from sistd_usuario where no_usuario='" + Usuario.trim() + "' and pwr_usuario='" + PWD + "'";
